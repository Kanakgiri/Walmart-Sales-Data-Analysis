...
> Conduct analysis on the data to understand the different product lines, the product lines performing the best and the product lines that need to be improved.
...
> 1. Add a new column named `time_of_day` to give insights of sales in the Morning, Afternoon and Evening. This will help answer the question on which part of the day most sales are made.
...
7. Fetch each product line and add a column to those product lines showing "Good" or "Bad". Good if it's greater than average sales
...
9. Which day do the week has the best avg ratings?
